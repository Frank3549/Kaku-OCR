...
import com.kakutools.kaku.Windows.Window;
...
public class MainService extends Service implements Stoppable {
     ...
     * such a case onConfigurationChanged will not trigger and {@link Window#reInit(com.kakutools.kaku.Windows.Window.ReinitOptions)} will not
