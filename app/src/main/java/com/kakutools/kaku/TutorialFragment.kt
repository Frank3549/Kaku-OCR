...
import com.kakutools.kaku.Dialogs.TutorialExplainDialogFragment
...
class TutorialFragment : Fragment()
{
    ...
    override fun onResume()
    {
        ...
        mVideoView.setVideoURI(Uri.parse("android.resource://com.kakutools.kaku/${getVideoForSectionNumber(mPos)}"))
