...
import com.fuwafuwa.kaku.Windows.Window;
...
public class MainService extends Service implements Stoppable {
     ...
     * such a case onConfigurationChanged will not trigger and {@link Window#reInit(com.fuwafuwa.kaku.Windows.Window.ReinitOptions)} will not
