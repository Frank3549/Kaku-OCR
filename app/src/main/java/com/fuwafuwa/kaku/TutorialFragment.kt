...
import com.fuwafuwa.kaku.Dialogs.TutorialExplainDialogFragment
...
class TutorialFragment : Fragment()
{
    ...
    override fun onResume()
    {
        ...
        mVideoView.setVideoURI(Uri.parse("android.resource://com.fuwafuwa.kaku/${getVideoForSectionNumber(mPos)}"))
